...
/**
 * Premium 3D black hole accretion disk background.
 *
 * Renders an active gravitationally bound accretion disk with flowing
 * particles leaving fading trail lines. Uses 3D Z-depth sorting so particles
 * pass behind and in front of the central event horizon with physical occlusion.
 */
